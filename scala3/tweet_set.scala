...
object Main extends App {
    ...
    val he: Tweet = new Tweet("he", "hello", 3)
    val me: Tweet = new Tweet("me", "hi", 0)
    val be: Tweet = new Tweet("be", "gm", 2)
    val allN: TweetSet = allT.incl(he).incl(me).incl(be)
    allN.trending(List("h")).foreach({t => println(t.toString)})
}
